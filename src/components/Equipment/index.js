...
export default class Equipment extends Component {
  constructor() {
    ...
    render() {
        const { imageSwitch, roadster } = this.state 
              ...
              id="page1">
                <Content> 
                    <Tabs>
                      ...
                      <Folder>
                          <StyledTab onClick={() => this.switchImage()}>ROCKETS</StyledTab>
                          <StyledTab onClick={() => this.switchImage()}>ROADSTER</StyledTab>
                      </Folder>
